(function () {
    ...
    sgtApp.controller('profesionalEditController', ['crudService', profesionalEditController]);
    ...
    function profesionalEditController(crudService) {
        var vm = this;
        vm.error = '';
        vm.Tipos = [];
        vm.checkBoxTipos = {};        
