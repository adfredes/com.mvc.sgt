    ...
    (function () {
        ...
        function setContextMenu() {
            ...
            let showModalCancelarSesion = (sesionID, turnoID) => {
                modal = document.querySelector('#cancelarSesionModal');
            ...
            function contextMenuClick(key, opt, e) {
                switch (key) {
                    ...
                    case 'anularSesion':
                        ...
                        break;
                    case 'cambiarTurno':
                        let sesionView = document.querySelector('#ctrlEditSesionGrilla');
                    ...
                    case 'datosSesiones':
                        break;
                    case 'posponer':
                        modal = document.querySelector('#posponerTurnoModal');
