            ...
            return {
                ...
                controller: ['$scope', 'crudService', '$window', '$mdSelect', function ($scope, crudService, $window, $mdSelect) {
                        ...
                        $scope.setTouch = function () {
                            angular.forEach($scope.frmAseguradora.$error, function (field) { return angular.forEach(field, function (errorField) {
...
//# sourceMappingURL=AseguradoraDirectives.js.map